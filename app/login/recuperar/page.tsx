...
export default function RecuperarPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setNotice(
        'Te enviamos un correo con instrucciones para restablecer tu contraseña. Si no lo ves en unos minutos, revisa tu carpeta de Spam o Promociones.'
      );
    } finally {
      setSending(false);
    }
  ...
  return (
    <main className="flex flex-1 items-center justify-center px-6 py-16">
      <div className="w-full max-w-sm">
        <h1 className="mb-8 font-serif text-3xl text-parchment">Recuperar contraseña</h1>
